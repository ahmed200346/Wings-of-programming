...
switch(collisionBB(*entity,*Hero,400,400))
{
	case 1 :
	if(entity->i >= 2)
		entity->i = 0;
	if( entity->direction == RIGHT && collisionBB(*entity , *Hero , 20, 20 ) != 1 )
	{	
		entity->etat = TURN ;
		if(entity->NbmaxImg != 2)
		{
	...
	if( Hero->Attack == 1 && collisionBB(*entity , *Hero ,3 ,3 ) == 1 )
	{
	...
	else if( collisionBB( *entity , *Hero ,  0 , 0 ) == 1 && entity->etat == ATTACK )
	{
        	Hero->PosEcran.x -= 150 ;
        	Hero->vie--;
	}
	...
	if(entity->i >= 2)
		entity->i = 0;
	if(entity->direction == LEFT && collisionBB(*entity , *Hero , 20,20) != 2 )
	{
		entity->etat = TURN ;
		if(entity->NbmaxImg != 2)
		{
	...
	if( Hero->Attack == 1 && collisionBB(*entity , *Hero , 3 , 3 ) == 2)
	{
		entity->y -=   10*SPEED_MAX ;
        	entity->x -=10*SPEED_MAX ;
        	entity->life--;
	...
	else if( collisionBB( *entity , *Hero , 0 , 0) == 2 && entity->etat == ATTACK )
	{
        	Hero->PosEcran.x += 150 ;
        	Hero->vie--;
	}
	...
	if(entity->i >= 2)
		entity->i = 0;
	if( entity->direction == RIGHT && collisionBB(*entity , *Hero , 20 , 20 ) != 3 )
	{
	...
	if( Hero->Attack == 1 && collisionBB(*entity , *Hero ,  3 , 3 ) == 3)
	{
		entity->y -=   10*SPEED_MAX ;
        	entity->x += 10*SPEED_MAX ;
        	entity->life--;
	...
	else if( collisionBB( *entity , *Hero ,   0 , 0 ) == 3 && entity->etat == ATTACK )
	{
        	Hero->PosEcran.x -= 150 ;
        	Hero->vie--;
	}
	...
	if(entity->i >= 2)
		entity->i = 0;
	if( entity->direction == LEFT && collisionBB(*entity , *Hero , 20 , 20 ) != 4 )
	{
		entity->etat = TURN ;
		if(entity->NbmaxImg != 2)
		{
	...
	if( Hero->Attack == 1 && collisionBB( *entity , *Hero , 3 , 3 ) == 4 )
	{
		entity->y -=  10*SPEED_MAX ;
        	entity->x -= 10*SPEED_MAX ;
        	entity->life--;
	...
	else if( collisionBB( *entity , *Hero , 0 , 0 ) == 4 && entity->etat == ATTACK )
	{
        	Hero->PosEcran.x += 150 ;
        	Hero->vie--;
	}
...
printf("\ncolelephant:%d \t i1:%d ",collisionBB(*entity ,*Hero,400, 200) , entity->NbPas);		
}

...
if( entity->life > 0)
{
switch(collisionBB(*entity ,*Hero,150, 400))
{
	case 1 : 
	...
	if( collisionBB(*entity, *Hero , 100 , 30) == 1 && entity->etat != TURN && entity->i < 3)
	{
	...
	if( Hero->Attack == 1 && collisionBB(*entity , *Hero , 5 ,  PERSONNE_MAXH) == 1 && entity->etat != ATTACK )
	{
        	entity->SFX = 0 ;
        	entity->life--;
        	entity->x += 100 ;
	...
	else if( Hero->Attack != 1 && collisionBB(*entity , *Hero , 20 , 20 ) == 1 && entity->etat == ATTACK )
	{
		Hero->PosEcran.x -= 10*SPEED_MAX ;
        	Hero->vie--;
	}
break ; 
case 3 :
	...
	if( Hero->Attack == 1 && collisionBB(*entity , *Hero , 20 , 20) == 3 && entity->etat != ATTACK )
	{
        	entity->SFX = 0 ;
        	entity->life--;
        	entity->x += 100 ;
	...
	else if( Hero->Attack != 1 && collisionBB(*entity , *Hero , 20 ,  20) == 3 && entity->etat == ATTACK )
	{
		Hero->PosEcran.x -= 10*SPEED_MAX ;
        	Hero->vie--;
	}
...
case 4 :
	...
	if( collisionBB(*entity, *Hero , 100 , 30) == 4 && entity->etat != TURN && entity->i < 3)
	{
		entity->etat = ATTACK ;
		if( entity->NbmaxImg != 12 )
		{
	...
	if( Hero->Attack == 1 && collisionBB(*entity , *Hero , 20 , 20 ) == 4 && entity->etat != ATTACK )
	{
        	entity->SFX = 0 ;
        	entity->life--;
        	entity->x -= 100 ;
	...
	else if( Hero->Attack != 1 && collisionBB(*entity , *Hero , 20 ,  20) == 4 && entity->etat == ATTACK )
	{
		Hero->PosEcran.x += 10*SPEED_MAX ;
        	Hero->vie--;
	}
...
case 2 :
	...
	if( collisionBB(*entity, *Hero , 100 , 30) == 2 && entity->etat != TURN && entity->i < 3)
	{
		entity->etat = ATTACK ;
		if( entity->NbmaxImg != 12 )
		{
	...
	if( Hero->Attack == 1 && collisionBB(*entity , *Hero , 20 , 20) == 2 && entity->etat != ATTACK )
	{
        	entity->SFX = 0 ;
        	entity->life-- ;
        	entity->x -= 100 ;
	...
	else if( Hero->Attack != 1 && collisionBB(*entity , *Hero , 20 ,  20) == 2 && entity->etat == ATTACK )
	{
		Hero->PosEcran.x += 10*SPEED_MAX ;
        	Hero->vie--;
	}
...
switch (entity.etat)
    {
        case IDLE:
        	Mix_PlayChannelTimed(-1,entity.Walk, 0 ,500);
        break;
        case SUIVRE:
        ...
        case RUN:  
        	...
        	if( entity.SFX == 3 )   
                	Mix_PlayChannelTimed(-1, entity.Run, 0 , 500);  
        break;
   }
}
